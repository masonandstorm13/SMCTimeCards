...
public class newMachine extends javax.swing.JFrame {
    ...
    private void initComponents() {
    			...
    			if(cost != null) {
    				if(TextField_MachineCode.getText().equals("")) {
                		...
                		for(int i = 0; i < Frame.getFrames().length; i++) {
                			if(Frame.getFrames()[i].getTitle().equals("newMachine")) {
        ...
        LabelProfilePicture.setIcon(new ImageIcon(newMachine.class.getResource("/Resources/user-picture.png"))); // NOI18N
