...
public class editEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TextField_Name.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseClicked(MouseEvent arg0) {
        		JOptionPane.showMessageDialog(getParent(),"Can't edit employee name");  
        	}
        });
        			...
        			if(hourly != null && charge != null) {
        				...
        				if(profilePicture.length() != 0) {
        					...
        					try {
        					    ...
        					    selectedEmployee.setCharge(charge);
        					    selectedEmployee.setHourlyPay(hourly);
        					    selectedEmployee.setPictureLocaitonPath(dest.getAbsolutePath());
                    			
                    			FileHandler fileHandler = new FileHandler();
                    			File newEmployeeLocation = new File(newEmployeeDirectory.getAbsolutePath() + "\\" + TextField_Name.getText() + ".json");
                    			fileHandler.writeFile(newEmployeeLocation, selectedEmployee);
        					} catch (IOException c) {
        						canSave = false;
        					    c.printStackTrace();
        					}
        				...
        				//runs if there is no profile picture selected
        					...
        					selectedEmployee.setCharge(charge);
        					selectedEmployee.setHourlyPay(hourly);
        					selectedEmployee.setPictureLocaitonPath(null);
        ...
        Label_ProfilePicture.setIcon(new ImageIcon(editEmployee.class.getResource("/Resources/user-picture.png"))); // NOI18N
        ...
        if(selectedEmployee.getPictureLocaitonPath() != null) {
        	Label_ProfilePicture.setIcon(new ImageIcon(selectedEmployee.getPictureLocaitonPath())); 
        }
        TextField_Name.setText(selectedEmployee.getName());
        TextField_Charge.setText(String.valueOf(selectedEmployee.getCharge()));
        TextField_Hourly.setText(String.valueOf(selectedEmployee.getHourlyPay()));
